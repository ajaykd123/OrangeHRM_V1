...
WebDriver driver;
	...
	public Admin_Objects(WebDriver driver) {
		 this.driver = driver;
	}

	By Admin_Nav = By.xpath("//b[contains(text(),'Admin')]");
	public WebElement getAdminNav() {
		return driver.findElement(Admin_Nav);
	}
	By Admin_UserManagement_Nav = By.xpath("//a[@id='menu_admin_UserManagement']");
	public WebElement getAdmin_UserManagement_Nav() {
		return driver.findElement(Admin_UserManagement_Nav);
	}
